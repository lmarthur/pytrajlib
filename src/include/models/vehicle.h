...
booster init_mmiii_booster(runparams run_params){
    ...
    */
    ...
    // Thrust angles
    booster.thrust_angles.lat = run_params.theta_lat + run_params.init_thrust_lat_pert;
    booster.thrust_angles.lon = run_params.theta_long + run_params.init_thrust_lon_pert;
