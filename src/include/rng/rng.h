...
double ran_gaussian(double stddev) {
    ...
    deviation stddev. Uses the Box-Muller transform to generate two independent
    standard normal random variables from two independent uniform random
    variables. Only one of the random variables is returned per call.

    Modified from p. 289-290 of Winkler, J. R. Numerical recipes in C: The Art
    of Scientific Computing. (1993).
