...
double ran_gaussian(double stddev) {
  ...
  stddev. Uses the Box-Muller transform to generate two independent standard
  normal random variables from two independent uniform random variables. Only
  one of the random variables is returned per call.
