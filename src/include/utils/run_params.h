...
typedef struct runparams {
  ...
  // atmosphere double time_step_reentry; // time step in seconds during reentry
  ...
  // meters double step_acc_dur; // Step acceleration perturbation duration in
  // seconds double step_acc_angle; // Step acceleration perturbation angle in
  // radians. 0 = along lift vector, -1 is single random direction for duration
  // of run
