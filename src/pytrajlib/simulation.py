...
def add_arguments_to_parser(parser):
    ...
    help_text = {
        ...
        "atm_model": f"Atmospheric model to use. 0 = exponential model, 1 = exponential model with Gaussian wind perturbations, 2 = EarthGRAM 2016 model below 100km altitude. (default: {run_params['atm_model']})",
