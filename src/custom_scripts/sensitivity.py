...
plt.annotate('Initial Position', (x[-1], cep_pos[-1]), xytext=(-50,-15), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
plt.annotate('Initial Vel.', (x[-3], cep_vel[-3]), xytext=(-7,31), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
plt.annotate('Initial Angle', (x[-1], cep_ang[-1]), xytext=(-31, 20), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
...
plt.annotate('Gyro Bias', (x[-1], cep_gyrob[-1]), xytext=(-50, -20), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
plt.annotate('Gyro Noise', (x[-1], cep_gyron[-1]), xytext=(-24,19), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
...
plt.annotate('Initial Angle', (x[-1], cep_ang[-1]), xytext=(-30, -40), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
...
plt.annotate('Initial Vel.', (x[-2], cep_vel[-2]), xytext=(18,-20), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
plt.annotate('Initial Angle', (x[2], cep_ang[2]), xytext=(-40, 20), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
plt.annotate('Acc. Scale', (x[-3], cep_acc[-3]), xytext=(-50, -6), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
plt.annotate('Gyro Bias', (x[-2], cep_gyrob[-2]), xytext=(0, 30), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
...
if run_3_params.gnss_nav:
    plt.annotate('GNSS Error', (x[2], cep_gnssn[2]), xytext=(20, 3), textcoords = "offset points", arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-.2', color='black'))
